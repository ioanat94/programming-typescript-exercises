// 1. Implement a general-purpose promisify function, which takes any
// function that takes exactly one argument and a callback and wraps
// it in a function that returns a promise. When you’re done, you
// should be able to use promisify like this (install type declarations
// for NodeJS first, with npm install @types/node --save-dev):
...
// 2. In the section on “Typesafe protocols” we derived one half of a
// protocol for typesafe matrix math. Given this half of the protocol
// that runs in the main thread, implement the other half that runs in a
// Web Worker thread.
